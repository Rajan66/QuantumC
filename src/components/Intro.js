    ...
    <section id="intro" className='bg-white lg:p-10'>
      <div className='flex flex-col lg:flex-row justify-center lg:p-5 lg:gap-20 lg:mx-52'>
        ...
        <div className='flex flex-col justify-start items-start p-6'>
          <h1 className='text-2xl md:text-3xl lg:text-4xl font-extrabold mb-2 md:mb-3 lg:mb-5 '>Learn more about</h1>
          <h1 className='text-2xl md:text-3xl lg:text-4xl font-extrabold mb-2 md:mb-3 lg:mb-5 bg-gradient-to-br from-purple-600 to-cyan-400 bg-clip-text text-transparent'>QUANTUM COMPILERS</h1>
